...
everyYear = [2018, 2019, 2020, 2021, 2022, 2023]
numOfHouseholdsWithPetsYears = [2018, 2020, 2022, 2023]

numOfHouseholdsWithPets = [84.9, 90.5, 86.9, 82]
petCareSpending = [90.5, 97.1, 103.6, 123.6, 136.8, 147]
